...
<x-layout>
    ...
    <section class="mt-30 max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
        <h2 class="text-lg font-semibold text-gray-700 capitalize dark:text-white">Update Post</h2>
        ...
        <form action="{{ route('show.update', $post->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                ...
                <div>
                    <label class="text-gray-700 dark:text-gray-200" for="password">Content</label>
                    <textarea name="content" id="content" rows="4"
                        ...
                        placeholder="White here...">{{ $post->content }}</textarea>
                </div>
            ...
            <div class="flex justify-end mt-6">
                <button type="submit"
                    class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-blue-700 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600 cursor-pointer">Update
                </button>
            </div>
        </form>
    </section>
