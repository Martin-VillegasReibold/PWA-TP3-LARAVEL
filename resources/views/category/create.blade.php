...
<x-layout>
    <section class="mt-30 max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
        <h2 class="text-lg font-semibold text-gray-700 capitalize dark:text-white">Create new Post</h2>
        ...
        <form action="{{ route('show.store') }}" method="POST">
            ...
            <div class="flex justify-end mt-6">
                <button type="submit"
                    class="px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-blue-700 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600 cursor-pointer">Public
                    Post</button>
            </div>
        </form>
    </section>
