...
<x-layout>
    ...
    <section>
        <div class="container px-6 py-10 mx-auto">
            ...
            <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Pagina Index</h1>
                ...
                @foreach ($posts as $post)
                    <div class="lg:flex bg-white shadow dark:bg-gray-800 p-3 rounded-xl">
                        ...
                        <div class="flex flex-col justify-between py-6 lg:mx-6">
                            ...
                            <span class="text-sm text-gray-500 dark:text-gray-300">{{ $post->created_at }} |
                                {{ $post->user->name }}</span>
                        </div>
                    </div>
                @endforeach
